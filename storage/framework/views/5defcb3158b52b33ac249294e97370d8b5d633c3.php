...
<title>ระบบหน้าร้าน - 	<?php echo $__env->yieldContent('title'); ?></title>
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <span class="nav-link"><?php echo e(session('BchName')); ?></span>
        </li>
    </ul>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="<?php echo e(asset('assets/img/logo.jpg')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
            <a href="#" class="d-block"><?php echo e(session('FTUsrName')); ?></a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            ...
            <?php $chkli  = '0'; ?>
            <?php $__currentLoopData = $data['permission']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <?php if($row->FNMnuVisible == 0): ?>
            <?php
            if($chkli!=0){
                echo '</ul></li>';
                $chkli = 0 ;
            ...
            ?>
            <li class="nav-item">
                <a href="<?php echo e(url("$row->FTMnuName")); ?>" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>

                    <p><?php echo e($row->FTMnuEngDesc); ?> - <?php echo e($row->FNMnuVisible); ?> - <?php echo e($chkli); ?></p>
                </a>
            </li>
            <?php elseif($row->FNMnuVisible == 1): ?>
            <?php
                if($chkli!=0){
                    echo '</ul></li>';
                }
            ...
            <li class="nav-item">
                <a href="" class="nav-link">
                    ...
                    <p>
                        <?php echo e($row->FTMnuEngDesc); ?> - <?php echo e($row->FNMnuVisible); ?> - <?php echo e($chkli); ?>
...
<?php /**PATH D:\Ekapab\frontend2\resources\views/index.blade.php ENDPATH**/ ?>